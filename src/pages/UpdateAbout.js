...
//             transition={{ delay: 0.2, duration: 0.5 }}
//             className="max-w-[400px] relative max-h-[300px] border-black border-4 rounded-lg z-100 before:absolute before:bg-black before:bottom-2 before:right-[4rem] before:h-[70%] before:w-[100%]  before:z-[-1] ">
//             <img
//               src={myImage2}
...
//             <h2 className="text-[1.5rem]">Development</h2>
//             <p>
